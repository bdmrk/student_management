            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <input type="date" name="start_date" class="form-control" placeholder="01/01/2019"/>
                            <span class="text-danger">{{$errors->has('start_date') ? $errors->first('starting_date') : ''}}</span>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-md-3">Ending Date</label>
                        <div class="col-md-6">
                            <input type="date" name="end_date" class="form-control" placeholder="01/01/2019"/>
                            <span class="text-danger">{{$errors->has('end_date') ? $errors->first('ending_date') : ''}}</span>
                        </div>
                    </div>
